  ...
  return (
    <div className="max-w-5xl mx-auto pt-24 px-6 relative z-10">
      <div className="flex items-center justify-between mb-10">
        ...
        {/* Button to trigger your "Create Group" logic if needed */}
        <button className="bg-blue-600 hover:bg-blue-500 text-white px-5 py-2.5 rounded-xl font-bold transition-all">
          New Group
        </button>
      </div>
